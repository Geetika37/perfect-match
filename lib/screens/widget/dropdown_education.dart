...
class DropdownEducation extends StatefulWidget {
  ...
  final double margin;
  final IconData icon;
  final RxString educationController;

  @override
  State<DropdownEducation> createState() => _DropdownEducationState();
}

class _DropdownEducationState extends State<DropdownEducation> {
        ...
        DropdownButtonFormField<String>(
          ...
          onChanged: (String? newValue) {
            setState(() {
              ...
              widget.educationController.value = newValue;
            });
          },
          items: <String>['Select', '10th', '12th', 'UG', 'PG', 'PHD']
